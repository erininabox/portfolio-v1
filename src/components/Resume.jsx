    ...
    render() {
        return (
            <div className="component">
                ...
                <h2 className="emphasis-text resume-section">Education</h2>
                    <p className="degree">
                        <span className="degree-year">9/2021
                            </span> 
                        <span className="degree-name">Software Engineering Immersive
                            <br />General Assembly | San Francisco
                            </span>
                    </p>
                    <p className="degree">
                        <span className="degree-year">12/2010
                            </span> 
                        <span className="degree-name">MA Linguistics 
                            <br />CSUN | Northridge, CA
                            </span>
                    </p>
                    <p className="degree">
                        <span className="degree-year">6/2004
                            </span> 
                        <span className="degree-name">BA Natural Sciences
                            <br />Evergreen State College | Olympia
                            </span>
                    </p>
                

                <h2 className="emphasis-text">Professional History</h2>
